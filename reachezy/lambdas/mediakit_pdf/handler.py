...
def _fetch_creator_data(creator_id):
    ...
    data = {
        ...
        "content_format": style_profile.get("primary_content_type", "N/A"),
        "production": style_profile.get("production_quality", "N/A"),
        "topics": ", ".join(style_profile.get("topics", [])) or "N/A",
        "consistency_score": str(style_profile.get("consistency_score", "N/A")),
        "video_count": str(style_profile.get("video_count", 0)),
        "face_percentage": str(style_profile.get("face_visible_pct", 0)),
